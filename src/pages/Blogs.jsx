        ...
        <div className="relative h-full flex items-center justify-center pt-16 sm:pt-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            >
              ...
              <p className="text-xs sm:text-sm md:text-base lg:text-lg text-white/80 mb-5 sm:mb-6 max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 max-w-xl mx-auto">
                {[
                  ...
                  { icon: TrendingUp, value: "98%", label: "Useful" },
                  { icon: Zap, value: "24/7", label: "Updated" },
                ].map((stat, index) => (
                  <motion.div
                    key={index}
                    ...
                    className="bg-white/10 backdrop-blur-md rounded-lg sm:rounded-xl p-2 sm:p-3 border border-white/10"
                  >
                    <div className="flex items-center justify-center gap-1.5 sm:gap-2">
                      <div className="p-1 sm:p-1.5 bg-white/20 rounded-md text-white">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-[8px] sm:text-[9px] md:text-[10px] text-white/70">
                          {stat.label}
                        </div>
                      </div>
                    </div>
