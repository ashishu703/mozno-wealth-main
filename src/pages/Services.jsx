  ...
  const serviceCategories = [
    {
      ...
      desc: "Strategic portfolio management",
    },
    {
      icon: PieChart,
      label: "Financial Planning",
      path: "/services/financial-planning",
      desc: "Goal-based financial planning",
    },
    {
      icon: Calculator,
      label: "Tax Advisory",
      path: "/services/tax-planning",
      desc: "Direct & indirect tax guidance",
    },
    {
      icon: Shield,
      label: "Insurance",
      path: "/services/insurance-planning",
      desc: "Coverage for life & health",
    },
    {
      icon: Landmark,
      label: "Borrowing",
      path: "/services/borrowing-solutions",
      desc: "Financing for the right moments",
    },
    {
      icon: Users,
      label: "Succession Planning",
      path: "/services/succession-planning",
      desc: "Will & estate planning",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-600 mt-3 max-w-xl mx-auto">
              Choose the category you need and explore dedicated solutions.
            </p>
          </motion.div>

          <div className="max-w-6xl mx-auto">
            <ServicesCarousel items={serviceCategories} />
          </div>
        </div>
      </section>
