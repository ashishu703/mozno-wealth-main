...
const WealthManagement = () => {
  ...
  const investmentOptions = [
    ...
    },
    {
      ...
      oneLinerInsight:
        "SIFs bridge the gap between mutual funds and PMS — regulated safety, sophisticated strategy.",
    ...
    },
    {
      ...
      oneLinerInsight:
        "Every Infosys, Zomato, and Nykaa was once unlisted. The question is — what's next?",
    ...
    },
    {
      ...
      oneLinerInsight:
        "Your FD is quietly losing to inflation. Bonds earn more — and some are fully tax-free.",
    ...
    },
    {
      ...
      oneLinerInsight:
        "Structured products aren't complex — they're just precise. We decode them for you.",
    ...
    },
    {
      ...
      oneLinerInsight:
        "When the Nifty sleeps, the S&P 500 is wide awake. Your portfolio should never sleep.",
