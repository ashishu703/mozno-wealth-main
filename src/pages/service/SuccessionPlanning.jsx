...
const SuccessionPlanning = () => {
  ...
  const withoutWillProblems = [
    {
      icon: HelpCircle,
      title: "Families are Left Guessing",
      description:
        "Many times, heirs don't even know the complete list of assets: dormant bank accounts, forgotten FDs, multiple Demat holdings, insurance policies, or property documents tucked away.",
    },
    {
      icon: Users,
      title: "The Family Looks Up to YOU for Answers",
      description:
        "In their moment of grief, clients' families will turn to the person their loved one trusted the most – you. Suddenly, you're expected to guide them through legalities, paperwork, and disputes that could have been avoided with a simple Will.",
    },
    {
      icon: Scale,
      title: "Distribution is Never Simple Without a Will",
      description:
        "Courts decide as per succession law, not as per the client's wishes. This means a spouse might not get everything, minor children's shares are locked until they're adults, and family disputes become very common amongst siblings.",
    },
    {
      icon: XCircle,
      title: "Years of Planning Can Get Messed Up",
      description:
        "You may have spent years building and safeguarding a client's wealth. Yet, without a Will, that very wealth risks being delayed, eroded by legal costs, or fought over in court.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-600 mt-3 max-w-2xl mx-auto leading-relaxed">
              As a Financial Planner, you often become the most dependable
              person in a family's financial journey. Clients trust you not
              just with investments, but with the security of their future.
            </p>
          </motion.div>
