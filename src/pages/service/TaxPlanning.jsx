  ...
  const taxCards = [
    {
      ...
      description:
        "ITR filing, advance tax planning, capital gains structuring, old vs. new regime selection, and NRI taxation — your complete income tax lifecycle, handled.",
      chips: [
        "ITR Filing",
        "Advance Tax",
        "Capital Gains",
      ...
      ctaLabel: "Explore Income Tax Services",
    },
    {
      icon: FileText,
      ...
      chipClass: "bg-blue-50 border-blue-100 text-blue-800 hover:bg-blue-100",
      description:
        "GST registration, monthly/quarterly return filing, ITC optimisation, GSTR-2B reconciliation, GST audit, and show cause notice handling — compliance without the chaos.",
      chips: [
        "GSTR Filing",
        "ITC Claims",
        "GST Audit",
      ...
      ctaLabel: "Explore GST Advisory",
    },
    {
      icon: Receipt,
      title: "Other Indirect Taxes",
      bgClass: "bg-indigo-50 border-indigo-100",
      textClass: "text-indigo-900",
      chipClass:
        "bg-indigo-50 border-indigo-100 text-indigo-800 hover:bg-indigo-100",
      description:
        "Stamp duty, customs duty, professional tax, TDS/TCS compliance, and securities transaction tax — the indirect taxes most advisors overlook, handled with the same rigour as your ITR.",
      chips: ["Stamp Duty", "Customs Duty", "Professional Tax", "TDS/TCS", "STT"],
      ctaLabel: "Explore Indirect Tax Services",
    },
    {
      icon: BadgePercent,
      ...
      chipClass: "bg-teal-50 border-teal-100 text-teal-800 hover:bg-teal-100",
      description:
        "Salary restructuring, 80C/80D planning, HRA optimisation, NPS benefits, ELSS vs. PPF analysis, capital gains timing, and family income splitting — legal strategies that reduce your actual tax bill, not just your anxiety.",
      chips: [
        "Sec 80C Planning",
        "HRA Optimisation",
        "NPS",
      ...
      ctaLabel: "Build My Tax Strategy",
    },
    {
      icon: ClipboardCheck,
      ...
      description:
        "Received a notice from the IT Department or GST authorities? We decode it, draft the response, and represent you — within 24 hours of you reaching out. No panic. No delays. Resolved.",
      ctaLabel: "Request Tax Notice Help",
    },
  ];
  ...
  const approach = [
    {
      ...
      title: "Assess",
      description:
        "We review your income sources, existing investments, and current tax structure.",
    },
    {
      icon: Lightbulb,
      title: "Strategize",
      description:
        "Design a personalized tax-saving plan aligned with your financial goals.",
    },
    {
      icon: Target,
      title: "Implement",
      description:
        "Execute tax-saving investments and structure your finances for maximum benefit.",
    },
    {
      icon: BarChart3,
      title: "Monitor",
      description:
        "Ongoing tracking and adjustments to adapt to changing tax laws and life events.",
    },
  ];
  ...
  const taxSavingSections = [
    {
      section: "Section 80C",
      limit: "₹1.5 Lakh",
      items: ["PPF", "ELSS", "Life Insurance", "EPF"],
    },
    {
      section: "Section 80D",
      limit: "₹75,000",
  ...
  const faqs = [
    {
      ...
      answer:
        "Ideally at the start of the financial year (April). Early planning gives more options for tax-saving investments and better cash flow management throughout the year.",
    },
    {
      question: "What documents do I need for ITR filing?",
      answer:
        "Form 16, bank statements, investment proofs (80C, 80D, etc.), capital gains statements, and details of other income sources.",
    },
    {
      question: "Can you help with old/pending tax returns?",
      answer:
        "Yes, we can file updated/belated returns for previous years and help resolve any pending tax matters with the department.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-emerald-50/30">
      ...
      <section className="relative overflow-hidden pb-10 sm:pb-14 md:pb-20 lg:pb-24 pt-24 sm:pt-28 md:pt-32 lg:pt-36">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1600&q=80')] opacity-8 bg-cover bg-center" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <ChevronRight className="w-3.5 h-3.5" />
              <span className="text-emerald-300/80">Tax Planning</span>
            </motion.div>
            ...
            >
              Legally minimize your tax burden and maximize savings with expert
              guidance. Every rupee saved is a rupee earned.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-600 mt-3 max-w-xl mx-auto">
              Five focused help-categories for direct and indirect taxes.
            </p>
          </motion.div>
          ...
          >
            {taxCards.map((card, index) => (
              <motion.div
                ...
                variants={scaleIn}
                whileHover={{ y: -3 }}
                className={`rounded-2xl p-5 sm:p-6 shadow-sm border ${card.bgClass} hover:shadow-md transition-all duration-300`}
              >
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-11 h-11 rounded-xl bg-white/60 backdrop-blur flex items-center justify-center flex-shrink-0">
                    <card.icon className="w-5 h-5 text-gray-900" />
                  </div>
                  <div className="min-w-0">
                    <h3
                      className={`text-base sm:text-lg font-bold ${card.textClass || "text-gray-900"
                        }`}
                    >
                      {card.title}
                    </h3>
                ...
                <p
                  className={`text-sm leading-relaxed ${card.textClass || "text-gray-700"} mb-3`}
                >
                  {card.description}
                </p>
                ...
                {card.chips && (
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {card.chips.map((chip, idx) => (
                      <span
                        key={idx}
                        className={`px-2.5 py-1 rounded-full text-xs border ${card.chipClass}`}
                      >
                        {chip}
                      </span>
                    ))}
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-white to-emerald-50/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-600 mt-3 max-w-xl mx-auto">
              Key sections under the Income Tax Act that can help reduce your
          ...
          >
            {taxSavingSections.map((item, idx) => (
              <motion.div
                key={item.section}
                variants={scaleIn}
                whileHover={{ y: -3 }}
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5">
                  {item.items.map((point, i) => (
                    <span
                      key={`${point}-${i}-${idx}`}
                      className="text-xs text-gray-600 bg-gray-50 border border-gray-100 px-2 py-0.5 rounded-full"
                    >
                      {point}
                    </span>
                  ))}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-emerald-100/80 text-sm sm:text-base mb-6 sm:mb-8 max-w-lg mx-auto leading-relaxed">
                ...
                proper tax planning tailored to your situation.
              </p>
