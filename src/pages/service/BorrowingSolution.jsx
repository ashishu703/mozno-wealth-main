  ...
  const loanTypes = [
    {
      ...
      title: "Home Loan",
      description:
        "Your home is the biggest purchase of your life. We help you compare lenders, negotiate the best deal, structure your EMI to align with your cash flows, and plan the tax benefits simultaneously.",
    ...
    },
    {
      ...
      description:
        "Already own property? Unlock its value without selling it. LAP gives you large-ticket funding with a lighter repayment burden than many alternatives — ideal for business expansion, education, or debt consolidation.",
    ...
    },
    {
      ...
      description:
        "Don't liquidate your investments when you need cash. Pledge your mutual funds, stocks, bonds, or insurance policies and access instant liquidity — while your portfolio continues to grow.",
      color: "from-teal-500 to-emerald-500",
      roi: "8.8% p.a.",
      tenure: "As per collateral & lender policy",
    },
    {
      icon: HandCoins,
      title: "Distress Funding",
      description:
        "Your Business is going through a turbulent time. We arrange for capital that will restart your business and take it to new heights.",
      color: "from-amber-500 to-orange-500",
      roi: "Case-based pricing",
      tenure: "Flexible as per structure",
    },
    {
      icon: CreditCard,
      title: "Consumer Loan",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-600 mt-3 max-w-xl mx-auto">
              Compare smarter, borrow better - clear ROI, right tenure, and the
              best-fit loan matched to your real need.
            </p>
          </motion.div>
