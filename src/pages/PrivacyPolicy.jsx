...
import { Shield, Eye, Lock, Database, Share2, UserCheck, Bell, Settings, Mail, Phone, MapPin } from "lucide-react";
...
We are a comprehensive wealth management firm founded by Harshal Jain (CA, CFA) and registered with AMFI (ARN-338534) and APMI (APRN08037). We operate in compliance with applicable Indian laws including the Information Technology Act, 2000 and its rules.
            ...
            <div className="grid gap-4 min-[375px]:gap-5 sm:gap-6 sm:grid-cols-2">
              ...
              <div className="flex items-start gap-3 min-[375px]:gap-4">
                ...
                <div>
                  ...
                  <a href="tel:9820507696" className="text-sm text-emerald-600 hover:underline">
                    +91 98205 07696
                  </a>
                </div>
              </div>
