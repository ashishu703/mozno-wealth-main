...
const CONTACT_STAT_ICONS = [HeadphonesIcon, Clock, CheckCircle, Globe];
...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-emerald-50/30">
      ...
      <section className="relative overflow-hidden pb-10 sm:pb-14 md:pb-20 lg:pb-24 pt-24 sm:pt-28 md:pt-32 lg:pt-36">
        ...
        <div className="relative max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.h1
              variants={fadeInUp}
              className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4 xs:mb-6"
            >
              Contact Us For{" "}
            ...
            <motion.p
              variants={fadeInUp}
              className="text-sm xs:text-base sm:text-lg md:text-xl text-white/80 max-w-3xl mx-auto mb-6 xs:mb-8 px-2"
            >
              Ready to take control of your financial future? Our team of CA &
              CFA experts is here to guide you every step of the way.
            </motion.p>
            ...
            >
              <a
                ...
                className="group flex items-center gap-2 px-4 xs:px-6 py-2.5 xs:py-3 bg-white text-emerald-700 font-semibold rounded-xl hover:bg-emerald-50 transition-all shadow-lg shadow-white/20 text-sm xs:text-base"
              >
                <Phone className="w-4 h-4 xs:w-5 xs:h-5" />
                <span>+91 98205 07696</span>
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </a>
              <a
                href="mailto:ceo@mozno.in"
                className="group flex items-center gap-2 px-4 xs:px-6 py-2.5 xs:py-3 bg-white/10 backdrop-blur-md text-white font-semibold rounded-xl border border-white/20 hover:bg-white/20 transition-all text-sm xs:text-base"
              >
                <Mail className="w-4 h-4 xs:w-5 xs:h-5" />
                <span>ceo@mozno.in</span>
              </a>
            </motion.div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="relative h-[250px] xs:h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px]">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3769.8876!2d72.8567!3d19.1136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTnCsDA2JzQ5LjAiTiA3MsKwNTEnMjQuMSJF!5e0!3m2!1sen!2sin!4v1234567890"
            ...
            >
              ...
              <div className="mb-6 xs:mb-8">
                ...
                <p className="text-sm xs:text-base text-gray-600 leading-relaxed">
                  ...
                  seeking investment advice, our team of CA & CFA experts is
                ...
                {[
                  {
                    ...
                    text: "106, Shyamkamal 'C' Building, Agarwal Market, Vile Parle East, Mumbai - 400 057",
                    subtext: "Location: https://maps.app.goo.gl/VQSp7vAJ3kTvGcW47 (editable in admin panel)",
                    color: "from-emerald-500 to-teal-500",
                    link: "https://maps.app.goo.gl/VQSp7vAJ3kTvGcW47",
                  },
                  {
                    icon: Mail,
                    title: "Email Us",
                    text: "contact@mozno.in",
                    subtext: "Less than 24 hrs response time",
                    color: "from-cyan-500 to-blue-500",
                    link: "mailto:contact@mozno.in",
                  },
                  {
                    icon: Phone,
                    title: "Call Us",
      ...
      {/* ================= FAQ TEASER ================= */}
      <section className="py-8 xs:py-12 sm:py-16 bg-gradient-to-b from-white to-emerald-50/50">
        <div className="max-w-4xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-xl xs:text-2xl sm:text-3xl font-bold text-gray-900 mb-3 xs:mb-4">
              Have Questions?
            </h2>
            <p className="text-sm xs:text-base text-gray-600 mb-5 xs:mb-6">
              Check out our comprehensive FAQ section or reach out directly.
            </p>
            <div className="flex flex-col xs:flex-row items-center justify-center gap-3 xs:gap-4">
              <a
                href="/faqs"
                className="inline-flex items-center gap-2 px-5 xs:px-6 py-2.5 xs:py-3 bg-white border-2 border-emerald-500 text-emerald-700 font-semibold rounded-xl hover:bg-emerald-50 transition-all text-sm xs:text-base"
              >
                View FAQs
              ...
              <a
                href="tel:+919820507696"
                className="inline-flex items-center gap-2 px-5 xs:px-6 py-2.5 xs:py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-emerald-500/30 transition-all text-sm xs:text-base"
              >
