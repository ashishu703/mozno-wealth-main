...
const FOUNDER_TITLE_WORDS = ["From", "the", "Founder"];
...
const About = () => {
  ...
  const [founderTitleCount, setFounderTitleCount] = useState(() => {
    if (typeof window === "undefined") return 0;
    try {
      return window.matchMedia("(prefers-reduced-motion: reduce)").matches
        ? FOUNDER_TITLE_WORDS.length
        : 0;
    } catch {
      return 0;
    }
  ...
  useEffect(() => {
    ...
    if (founderTitleCount >= FOUNDER_TITLE_WORDS.length) return;
    const id = window.setTimeout(
      () => setFounderTitleCount((c) => c + 1),
      280,
    );
  ...
  const credentials = [
    { icon: GraduationCap, title: "Chartered Accountant (CA)", org: "ICAI" },
    { icon: Award, title: "CFA Charterholder", org: "CFA Institute, USA" },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-emerald-50/30 overflow-x-hidden ">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              expertise with a personal touch since 2020.
            </Motion.p>
      ...
      <section className="py-6 sm:py-10 md:py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-0">
              ...
              <div className="lg:col-span-2 bg-gradient-to-br from-emerald-600 to-teal-600 p-3 sm:p-4 md:p-5 lg:p-6 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-3 sm:mt-4 space-y-1.5 sm:space-y-2">
                    {[
                      {
                        title: "Dual Qualifications",
                        desc: "One of few professionals in India with both CA and CFA credentials",
                      },
                      {
              ...
              {/* Right: From the Founder — animated title + narrative */}
              <div className="lg:col-span-3 p-4 sm:p-5 md:p-6 lg:p-8">
                <h2
                  id="from-the-founder"
                  className="mb-8 sm:mb-10 flex flex-wrap items-baseline gap-x-2.5 sm:gap-x-3 gap-y-1 min-h-[2.75rem] sm:min-h-[3.25rem]"
                >
                  {FOUNDER_TITLE_WORDS.slice(0, founderTitleCount).map(
                    (word, i) => (
                      <Motion.span
                        key={`${word}-${i}`}
                        ...
                        className="text-xl sm:text-2xl md:text-3xl italic font-semibold text-emerald-600 tracking-tight"
                        style={{
                ...
                <div className="max-w-3xl space-y-4 sm:space-y-5 text-sm sm:text-base text-gray-700 leading-[1.7]">
                  ...
                  <p>Salaried professionals earning well but investing randomly.</p>

                  <p>Business owners building wealth but ignoring succession.</p>

                  <p>
                    Young earners buying the wrong insurance and missing the
                    right SIPs.
                  </p>

                  <p className="font-semibold text-gray-900 pt-1">
                    Everyone had products. Almost no one had a plan.
                  </p>

                  <p className="font-medium text-gray-900">
                    That&apos;s the gap Mozno Wealth was built to close.
                  </p>

                  <p>
                    Over 12+ years in financial services — across auditing,
                    investment advisory, taxation, and compliance — I&apos;ve
                    seen how fragmented financial advice in India really is.
                  </p>

                  <p>
                    One advisor for insurance. Another for mutual funds. A CA
                    for taxes. A lawyer for wills.
                  </p>
                  ...
                  <p
                    className="text-base sm:text-lg italic font-semibold text-emerald-700 leading-snug pt-2"
                    style={{
                      fontFamily: "Playfair Display, Georgia, serif",
                    }}
                  >
                  ...
                  <p className="font-medium text-gray-900">
                    Products come later, only if they truly fit.
                  </p>
                  ...
                  <p
                    className="text-base sm:text-lg italic font-semibold text-emerald-600 leading-snug"
                    style={{ fontFamily: "Playfair Display, Georgia, serif" }}
                  >
                    Making it simple is our job.
                  </p>
                </div>

                <figure className="max-w-3xl mt-8 sm:mt-10 border-l-4 border-emerald-500 bg-emerald-50/90 pl-4 sm:pl-6 pr-4 sm:pr-5 py-4 sm:py-5 rounded-r-xl shadow-sm">
                  <blockquote
                    className="text-sm sm:text-base md:text-lg text-gray-900 italic font-medium leading-relaxed"
                    style={{
                      fontFamily: "'Playfair Display', Georgia, serif",
                    }}
                  >
                    ...
                    best product.
                    <br />
                    I want to be the one who built you the best plan.&rdquo;
                  </blockquote>
                  <figcaption className="mt-3 sm:mt-4 text-xs sm:text-sm text-gray-600 font-medium not-italic tracking-wide">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col flex-1">
                ...
                <p className="text-[10px] sm:text-xs md:text-sm lg:text-base text-gray-300 mb-4 sm:mb-5 md:mb-6 flex-1 px-2 leading-relaxed max-w-xl mx-auto">
                  Join 500+ satisfied clients who trust Mozno Wealth with their
                  financial future. Let&apos;s build your wealth together.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-5 md:mb-6">
                  <Link
                    to="/contact"
                    className="w-full sm:flex-1 sm:max-w-[220px] inline-flex items-center justify-center gap-1.5 sm:gap-2 px-4 sm:px-5 md:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-semibold rounded-lg sm:rounded-xl hover:shadow-lg hover:shadow-emerald-500/30 transition-all text-[10px] sm:text-xs md:text-sm lg:text-base"
                  >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 md:gap-6 text-[9px] sm:text-[10px] md:text-xs lg:text-sm text-gray-400 mt-auto pt-2">
                  <a
                    href="mailto:contact@mozno.in"
                    className="flex items-center gap-1.5 sm:gap-2 hover:text-white transition-colors"
                  >
                    <Mail className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 shrink-0" />
                    contact@mozno.in
                  </a>
                  <a
