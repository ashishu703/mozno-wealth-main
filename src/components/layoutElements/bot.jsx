...
📅 Free Consultation: 30 minutes with CA/CFA expert
⚡ Response Time: Within 2 hours`,
      followUp: ['Book consultation', 'Our services', 'Fee structure', 'About team']
    },

    'qualifications': {
      answer: `Our Team Credentials:
...
🏛️ Regulatory Registrations:
• AMFI Registered (ARN-338534)
• APMI Distributor (APRN-08037)
• SEBI, RBI, IRDAI Compliant

Our dual CA+CFA expertise is rare in India!`,
      followUp: ['Our services', 'Free consultation', 'Contact details', 'Fee structure']
    },
...
✅ 30-minute session with CA/CFA expert
...
📅 How to Schedule:
1. Call +91 98205 07696
2. Email ceo@mozno.in
3. WhatsApp: wa.me/919820507696

⏱️ Available: Mon-Sat, 9AM-7PM`,
      followUp: ['Contact details', 'Our services', 'Fee structure', 'Team qualifications']
    }
  };
...
Please try one of the suggestions below!`;
  ...
  const quickActions = [
    ...
    { icon: <Shield className="w-3 h-3 sm:w-4 sm:h-4" />, label: 'Insurance', path: '/services/insurance' },
          ...
          >
                ...
                <div className="flex items-center gap-2 xs:gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <p className="text-emerald-100 text-[10px] xs:text-xs">Online • CA & CFA Expertise</p>
                    </div>
                  </div>
                </div>
                <button
            ...
            >
              <div className="flex items-center justify-center gap-1.5 xs:gap-2 text-[10px] xs:text-xs text-gray-500">
                ...
                <span>Powered by Mozno Wealth • CA & CFA Expertise</span>
              </div>
            </motion.div>
          </motion.div>
        )}
