    ...
    <section className="relative bg-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-3 min-[375px]:px-4 sm:px-6 lg:px-8 py-10 min-[375px]:py-12 sm:py-16 md:py-20 lg:py-24">
        ...
        >
          ...
          >
            Mozno Wealth is your comprehensive wealth partner. We offer
            integrated financial solutions tailored for every Indian family.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 min-[375px]:gap-8 sm:gap-10 lg:gap-14 xl:gap-16 items-center">
          ...
          >
            {/* Badge */}
            <div className="mb-2.5 min-[375px]:mb-3 sm:mb-4 md:mb-5">
            ...
            {/* Heading */}
            <h3 className="text-lg min-[375px]:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight mb-2.5 min-[375px]:mb-3 sm:mb-4 md:mb-5 break-words">
              Your Personal{" "}
              <span
                style={{ fontFamily: "Playfair Display, serif" }}
                className="text-emerald-600"
            ...
            {/* Description */}
            <p className="text-[12px] min-[375px]:text-[13px] sm:text-sm md:text-base lg:text-lg text-gray-600 leading-relaxed mb-4 min-[375px]:mb-5 sm:mb-6 md:mb-8 break-words overflow-wrap-break-word">
              We first understand your income, goals, risks, family needs and existing portfolio, and only then design a plan. Products come later, and only if they fit your life.
            </p>
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col min-[375px]:flex-row gap-2 min-[375px]:gap-2.5 sm:gap-3 md:gap-4">
              ...
              >
                <Link
                  to="/contact"
                  className="w-full min-[375px]:w-auto group flex items-center justify-center gap-1.5 min-[375px]:gap-2 sm:gap-2.5 px-3.5 min-[375px]:px-4 sm:px-5 md:px-6 py-2 min-[375px]:py-2.5 sm:py-3 md:py-3.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 text-[11px] min-[375px]:text-xs sm:text-sm md:text-base font-semibold rounded-lg min-[375px]:rounded-xl border border-emerald-200 hover:border-emerald-300 transition-all"
                >
                  <FileText className="w-4 h-4 min-[375px]:w-[18px] min-[375px]:h-[18px] sm:w-5 sm:h-5 shrink-0" />
