...
const defaultFaqs = [
  {
    ...
    a: [
      "Mozno Wealth is a comprehensive wealth management firm founded by Harshal Jain, a dual-qualified CA + CFA professional.",
...

  {
    ...
    a: [
      ...
      "Our CA + CFA expertise ensures the highest governance standards.",
    ],
  },
      ...
      <div className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16">
          ...
          <div className="lg:sticky lg:top-24 xl:top-28 h-fit">
            ...
            <button className="bg-teal-600 text-white px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-lg sm:rounded-xl shadow-md hover:bg-teal-700 transition text-xs sm:text-sm md:text-base">
              More Questions →
            </button>
          </div>
